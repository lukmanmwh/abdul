...
int tampilan(int n){
		gotoxy(25,0);cout<<"| Daftar Harga Barang Di Vitra Store |"<<endl;
...
//			menampilkan tabel sorting
		...
		case 4:{
			...
			biru();
			gotoxy(25,1);cout<<"toko swalayan"<<endl;
			reset();
...
merah();
cout<<"TERIMA KASIH TELAH BELANJA DI TOKO SWALAYAN"<<endl;
reset();
cout<<"Nim		: "<<nim<<endl;
cout<<"Nama		: "<<nm<<endl;
cout<<"Kelas		: "<<kls<<endl;
